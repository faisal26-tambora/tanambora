    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <p>
            <a href="{{ url('booking/add') }}" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-plus"></i>Booking Online</a>
            <a href="" class="btn btn-flat btn-sm btn-info btn-download"> <i class="fa fa-download"></i> Export To PDF</a>
            <button class="btn btn-flat btn-sm btn-success btn-print"> <i class="fa fa-print"></i> Print</button>
          </p>
